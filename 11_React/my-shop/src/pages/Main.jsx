...
import { getAllProducts, selectProductList, addMoreProducts, getMoreProductsAsync, selectStatus } from "../features/product/productSlice";
...
function Main() {
  ...
  useEffect(() => {
    // 서버에 상품 목록 요청
    axios.get('https://my-json-server.typicode.com/lis2s2/db-shop/products')
      .then((response) => {
      ...
      <section>
        ...
        <Button variant="secondary" className="mb-4" onClick={async () => {
          try {
            ...
            const result = await axios.get(`${process.env.REACT_APP_API_URL}/board/list`, {
              headers: {
                Authorization: token
                // Authorization: '1'
              }
...
// db.json파일 만들기
// 서버에 액세스하려면 https://my-json-server.typicode.com/<your-username>/<your-repo>를 방문 (내 아이디랑 주소 넣으셈)
